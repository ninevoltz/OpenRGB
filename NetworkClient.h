...
private:
    ...
    /*-----------------------------------------------------*\
    | Private SettingsManager functions                     |
    \*-----------------------------------------------------*/
    void                                SendRequest_SettingsManager_GetSettings(std::string settings_key);
    void                                SendRequest_SettingsManager_SaveSettings();
    void                                SendRequest_SettingsManager_SetSettings(std::string settings_json_str);
    void                                ProcessReply_SettingsManager_GetSettings();
